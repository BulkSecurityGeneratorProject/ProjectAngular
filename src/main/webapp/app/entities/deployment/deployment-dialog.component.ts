...
@Component({
    selector: 'jhi-deployments-dialog',
    templateUrl: './deployments-dialog.component.html'
})
export class DeploymentsDialogComponent implements OnInit {
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if (params['appid']){
                this.deploymentsPopupService
                    .opennew(DeploymentsDialogComponent as Component, null, params['appid']);
            } else if (params['id']) {
                this.deploymentsPopupService
                    .open(DeploymentsDialogComponent as Component, params['id']);
            } else {
                this.deploymentsPopupService
                    .open(DeploymentsDialogComponent as Component);
            }
        });
    }
